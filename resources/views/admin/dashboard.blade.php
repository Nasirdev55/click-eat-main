                    ...
                    <div class="d-flex flex-wrap">
                        <div class="py-3" style="flex:1">
                            <div class="card card-shadow p-3" style="width:210px;height:170px;position: relative;">
                                <h5>Total Orders</h5>
                                <img src="{{ asset('super-admin-assets/icons/orders.PNG') }}" alt="" style="width: 50px;height:50px;position: absolute;right:10px;top:10px">
                                <p class="mt-4"><b>800,999</b></p>
                                <div style="position: absolute;left:10px;bottom:10px">
                                    <img src="{{ asset('super-admin-assets/icons/arrow-b.PNG') }}" alt="" style="width: 30px;height:30px;">
                                    <span>7.1%</span>
                                </div>
                            </div>  
                        </div>
                        <div class="py-3" style="flex:1">
                            <div class="card card-shadow p-3" style="width:210px;height:170px;position: relative;">
                                <h5>Total Income</h5>
                                <img src="{{ asset('super-admin-assets/icons/income.PNG') }}" alt="" style="width: 50px;height:50px;position: absolute;right:10px;top:10px">
                                <p class="mt-4"><b>$800,999</b></p>
                                <div style="position: absolute;left:10px;bottom:10px">
                                    <img src="{{ asset('super-admin-assets/icons/arrow-r.PNG') }}" alt="" style="width: 30px;height:30px;">
                                    <span>2.5%</span>
                                </div>
                            </div>  
                        </div>
                        <div class="py-3" style="flex:1">
                            <div class="card card-shadow p-3" style="width:210px;height:170px;position: relative;">
                                <h5>Total Markete</h5>
                                <img src="{{ asset('super-admin-assets/icons/markete.PNG') }}" alt="" style="width: 50px;height:50px;position: absolute;right:10px;top:10px">
                                <p class="mt-4"><b>800,999</b></p>
                                <div style="position: absolute;left:10px;bottom:10px">
                                    <img src="{{ asset('super-admin-assets/icons/arrow-b.PNG') }}" alt="" style="width: 30px;height:30px;">
                                    <span>4.6%</span>
                        ...
                        <div class="py-3" style="flex:1">
                            <div class="card card-shadow p-3" style="width:210px;height:170px;position: relative;">
                                <h5>Total Clients</h5>
                                <img src="{{ asset('super-admin-assets/icons/clients.PNG') }}" alt="" style="width: 50px;height:50px;position: absolute;right:10px;top:10px">
                                <p class="mt-4"><b>800,999</b></p>
                                <div style="position: absolute;left:10px;bottom:10px">
                                    <img src="{{ asset('super-admin-assets/icons/arrow-b.PNG') }}" alt="" style="width: 30px;height:30px;">
                                    <span>7.1%</span>
                        ...
                        <div class="py-3" style="flex: 1;margin-right: 20px;">
                            <div class="card card-shadow p-3" style="position: relative;right:30px;">
                                ...
                                <table class="">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="p-2"><img src="{{ asset('super-admin-assets/icons/mcdonald-logo.png') }}" alt="" style="width:30px;height:30px"></td>
...
<script src="{{ asset('super-admin-assets/plugins/charts/charts.js') }}"></script>
<script>
