...
<div class="page-content container-fluid">
                <div class="d-flex">
                    <div>
                        <p class="ml-4 pt-3 mb-0" style="color:#6c63ff;font-size: 20px;">Restaurants Approval</p>
                    </div>
                    <div>
                    ...
                    <table class="table responsive" id="data-table" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$m->domain}}</td>
                                <td>
                                    <a href="{{url('admin/restaurant/approval/'.$m->id)}}" class="btn btn-primary">Approve</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                        </table> 
