<div class="page-topbar">
  ...
  <div class="dropdown-menu" id="user-menu-links">
    <a class="dropdown-item" href="#" onclick="document.querySelector('#vendor-logout').submit()">Logout</a>
    <form action="{{url('restaurant/logout')}}" id="vendor-logout" method="post">@csrf</form>
  </div>
</div>
                </div>
            </div>